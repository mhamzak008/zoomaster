...
public class SearchPanel extends JPanel {
	...
	static JComboBox[] comboBox_ = new JComboBox[5];
	/**
	 * Create the panel.
	 */
	public SearchPanel() {
		...
		btnSearch2.addActionListener(new SearchPanelListener());
		...
		btnSearch3.addActionListener(new SearchPanelListener());
		...
		btnSearch4.addActionListener(new SearchPanelListener());
		...
		btnSearch5.addActionListener(new SearchPanelListener());
		...
		btnSearch6.addActionListener(new SearchPanelListener());
		...
		prevButton.addActionListener(new SearchPanelListener());
		...
		nextButton.addActionListener(new SearchPanelListener());
		...
		btnNewButton.addActionListener( new SearchPanelListener());
		add(btnNewButton);
		...
		try {				
			...
			btnSearch.setRolloverIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/rollbutton2.png")));		//Start button icon when mouse entered 
			btnSearch.setIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/button2.png")));	
			btnSearch2.setRolloverIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/rollbutton2.png")));		//Start button icon when mouse entered 
			btnSearch2.setIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/button2.png")));
			btnSearch3.setRolloverIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/rollbutton2.png")));		//Start button icon when mouse entered 
			btnSearch3.setIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/button2.png")));
			btnSearch4.setRolloverIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/rollbutton2.png")));		//Start button icon when mouse entered 
			btnSearch4.setIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/button2.png")));
			btnSearch5.setRolloverIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/rollbutton2.png")));		//Start button icon when mouse entered 
			btnSearch5.setIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/button2.png")));
			btnSearch6.setRolloverIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/rollbutton2.png")));		//Start button icon when mouse entered 
			btnSearch6.setIcon(new ImageIcon(MainMenuPanel.class.getResource("/Buttons/button2.png")));
			backButton.setRolloverIcon(new ImageIcon(SearchPanel.class.getResource("/Buttons/rollbackbutton.png")));
			backButton.setIcon(new ImageIcon(SearchPanel.class.getResource("/Buttons/backbutton.png")));
			prevButton.setRolloverIcon(new ImageIcon(SearchPanel.class.getResource("/Buttons/rollbackbutton.png")));
			prevButton.setIcon(new ImageIcon(SearchPanel.class.getResource("/Buttons/backbutton.png")));
			nextButton.setRolloverIcon(new ImageIcon(SearchPanel.class.getResource("/Buttons/rollforwbutton.png")));
			nextButton.setIcon(new ImageIcon(SearchPanel.class.getResource("/Buttons/forwbutton.png")));
			mainBackground.setIcon(new ImageIcon(SearchPanel.class.getResource("/Background/Background2.jpg")));
